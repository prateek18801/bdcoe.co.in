                        ...
                        <div style="margin: 10px;">
                            <div>
                                ...
                                <div style="margin: 7px 0; color: black;">
                                    ...
                                    &nbsp;
                                    <div><strong>Date:</strong> 29 & 30 January</div>
                                    <div><strong>Time:</strong> 11:00am - 1:00pm</div>
                                    <div><strong>Venue:</strong> Google Meet</div>
                                    <p style="color: black">Keep checking your mailbox for further details.</p>
                                </div>
                                <p>
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="text-align: center;">
                                        <img src="https://drive.google.com/uc?export=view&id=1pIcdQFpCts-lyypJHZOSGzD805jtp5kg" alt="Tech Knockdown" style="width: 80%;">
                                    </td>
                                </tr>
                            </table>
                        </div>
